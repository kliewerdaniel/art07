        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-muted rounded-lg">
            ...
            <div className="space-y-1 text-xs">
              <p><strong>Admin:</strong> admin@artsaas.com</p>
              <p><strong>Artist:</strong> sarah.artist@example.com</p>
              <p><strong>Volunteer:</strong> emma.mentor@example.com</p>
              <p><strong>Donor:</strong> patron@example.com</p>
